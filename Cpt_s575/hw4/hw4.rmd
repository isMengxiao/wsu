...
summary(lm_medv2)
```
I have found that only the 'black' don't have non-linear association, since the P-value of  quandratic and cubic coefficients are all higher than 0.05. The other variables all have non-linear  association, but some of them only have quandratic association and the other have cubic.
